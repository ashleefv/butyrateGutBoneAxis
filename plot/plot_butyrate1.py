...
result0 = np.array(pickle.load(open('result0.p', 'rb')))
result01 = np.array(pickle.load(open('result01.p', 'rb')))
result02 = np.array(pickle.load(open('result02.p', 'rb')))
result3 = np.array(pickle.load(open('resulth.p', 'rb')))
T = np.array(pickle.load(open('time1.p', 'rb')))
...
plt.errorbar([28, 28],[42, 37.5], yerr=[1,1], fmt='o',color='r', elinewidth=3, markersize=10, capsize=6, capthick=3, barsabove= False)
